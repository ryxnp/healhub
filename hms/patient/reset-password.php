                ...
                <form class="form-login" name="passwordreset" method="post" onSubmit="return valid();">
                    <fieldset>
                            ...
                            <span style="color:red;">
                                <?php 
                                    ...
                                    if (isset($_SESSION['errmsg'])) {
                                        ...
                                        unset($_SESSION['errmsg']); // Clear the error message after displaying it
                                    }
                                ?>
                            </span>
                        </p>
                        ...
                        <div class="form-actions">
                            <button type="submit" class="btn btn-primary pull-right" name="change">Change <i class="fa fa-arrow-circle-right"></i></button>
                        </div>
