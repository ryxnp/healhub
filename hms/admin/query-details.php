...
$isread=1;
$query=mysqli_query($con,"update contact set  AdminRemark='$adminremark',IsRead='$isread' where id='$qid'");
if($query){
			...
			<div class="main-content">
				<div class="wrap-content container" id="container">
					...
					<div class="container-fluid container-fullw bg-white">
						...
						<div class="row">
							<div class="col-md-12">
								<h5 class="over-title margin-bottom-15">Manage <span class="text-bold">Query
										Details</span></h5>
								<hr />
								<table class="table table-hover" id="sample-table-1">
									...
									<tbody>
										<?php
$qid=intval($_GET['id']);
$sql=mysqli_query($con,"select * from contact where id='$qid'");
$cnt=1;
